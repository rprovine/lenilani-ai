...
async function checkConversation() {
  const sessionId = 'test-hubspot-1761301359183';
  ...
  if (data.lead_captured && data.contact_id) {
    ...
    console.log('\n❌ FAILED: HubSpot client is still NULL in production');
    console.log('   The condition at line 3171 never evaluated to true');
  }
}
